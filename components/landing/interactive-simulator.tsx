    ...
    <section id="simulador" className="py-14 sm:py-20 md:py-28 relative overflow-hidden bg-muted/30">
      ...
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-12">
          <Badge variant="outline" className="mb-3 px-3 py-1 border-primary/40 bg-primary/10 text-primary font-semibold text-xs">
            <Flame className="h-3.5 w-3.5 mr-1 text-amber-500 fill-amber-500" />
            Demostración en Tiempo Real
          </Badge>
          <h2 className="text-2xl sm:text-3xl md:text-5xl font-black tracking-tight text-foreground text-balance">
            Pruébalo tú mismo:{" "}
        ...
        <div className="rounded-2xl sm:rounded-3xl border border-border/80 bg-card/80 backdrop-blur-xl shadow-2xl p-4 sm:p-6 md:p-8">
          {/* Controls Header */}
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 pb-4 sm:pb-6 border-b border-border/50">
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 w-full sm:w-auto">
              ...
              <div className="flex flex-wrap gap-1.5 w-full sm:w-auto">
                ...
                <Button
                  ...
                  className="text-xs h-8 gap-1 flex-1 sm:flex-initial"
                >
            ...
            <Button
              ...
              disabled={isPlaying}
              className={`w-full sm:w-auto h-11 px-5 sm:px-6 font-bold shadow-lg transition-all duration-300 hover:scale-[1.02] text-xs sm:text-sm ${
                scenario === "duplicate"
          ...
          <div className="grid md:grid-cols-12 gap-5 sm:gap-6 mt-4 sm:mt-6 items-center">
            {/* Left: Interactive Phone Notification Preview */}
            <div className="md:col-span-6 bg-gradient-to-b from-muted/50 to-muted/20 border border-border/60 rounded-2xl p-3.5 sm:p-5 flex flex-col justify-center min-h-[230px] sm:min-h-[260px]">
              <div className="flex items-center justify-between mb-3 sm:mb-4 gap-2">
                <div className="flex items-center gap-1.5 sm:gap-2 text-xs font-semibold text-muted-foreground truncate">
                  <Smartphone className="h-4 w-4 text-primary shrink-0" />
                  <span className="truncate">Celular del Negocio</span>
                  <span className="hidden sm:inline text-muted-foreground/80">(Pantalla en uso)</span>
                </div>
                <span className="text-[10px] text-emerald-500 font-mono flex items-center gap-1 shrink-0">
            ...
            <div className="md:col-span-6 space-y-4">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 px-3.5 py-2.5 sm:px-4 sm:py-3 rounded-xl bg-primary/10 border border-primary/20 text-xs">
