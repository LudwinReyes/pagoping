...
export function Pricing() {
  ...
  return (
    <section id="planes" className="py-20 md:py-28 relative bg-muted/20">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <div className="mt-8 inline-flex items-center rounded-full p-1.5 bg-background border border-border/70 shadow-sm">
            <button
              type="button"
            ...
            >
              ...
              <span className="px-2 py-0.5 rounded-full text-[10px] bg-emerald-500 text-white font-bold tracking-tight">
                -25% OFF
              </span>
            </button>
          </div>
        ...
        >
          {plans.map((plan) => (
            <Card
              key={plan.name}
              className={`relative flex flex-col justify-between transition-all duration-300 rounded-3xl ${
                plan.highlighted
            ...
            >
              {plan.badge && (
                <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                  <Badge
                    className={`px-3 py-0.5 text-[11px] font-black tracking-wider uppercase shadow-md ${
                      plan.highlighted
              ...
              <CardContent className="space-y-6 flex-1 flex flex-col justify-between">
                ...
                <Button
                  className={`w-full h-11 font-bold rounded-xl transition-all duration-300 ${
                    plan.highlighted
        ...
        <div className="mt-12 text-center flex items-center justify-center gap-2 text-xs text-muted-foreground">
          <Shield className="h-4 w-4 text-emerald-500" />
          <span>Garantía de satisfacción: Puedes cancelar en cualquier momento sin penalizaciones.</span>
        </div>
      </div>
    </section>
  )
