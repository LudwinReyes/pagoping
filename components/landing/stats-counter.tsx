...
export function StatsCounter() {
  ...
  return (
    <section ref={containerRef} className="py-16 md:py-20 border-y border-border/50 bg-card/30 backdrop-blur-sm">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div className="space-y-1">
            <span
              ref={count1Ref}
              className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-primary font-mono"
            >
              +25,000
            </span>
          ...
          <div className="space-y-1">
            <span
              ref={count3Ref}
              className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-emerald-500 font-mono"
            >
              &lt; 0.2s
            </span>
            <p className="text-xs sm:text-sm font-medium text-muted-foreground">
          ...
          <div className="space-y-1">
            <span
              ref={count4Ref}
              className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-foreground font-mono"
            >
              S/ 0
            </span>
            <p className="text-xs sm:text-sm font-medium text-muted-foreground">
          ...
          <div className="space-y-1">
            <span
              ref={count2Ref}
              className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-indigo-500 font-mono"
            >
              99.9%
            </span>
            <p className="text-xs sm:text-sm font-medium text-muted-foreground">
        ...
        <div className="mt-14 pt-10 border-t border-border/40 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            {businessTypes.map((biz) => {
              ...
              return (
                <div
                  key={biz.name}
                  className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-background/80 border border-border/60 text-xs font-medium text-foreground shadow-sm hover:border-primary/40 transition-colors"
                >
